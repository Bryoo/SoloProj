...
class TestRoomClass(unittest.TestCase):
    ...
    def test_assign_room(self):
        ...
        initial_living = len(self.test.dojo.living_num)

        self.test_dojo.assign_room(self.fellow1, self.is_living)

        # self.assertEqual(1, len(self.test.dojo.office_num)- initial_offices)
        # self.assertEqual(1, len(self.test.dojo.living_num)- initial_living)
